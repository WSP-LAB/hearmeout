 ...
 * File path: frameworks/base/media/java/android/media/MediaPlayer.java
 ...
 *                SurfaceHolder holder, AudioAttributes audioAttributes, 
 *                int audioSessionId)
 *     2. private void startImpl()
 * Added functions:
 *     1. public void setContext(Context context)
 *     2. public void setDetector(DetectorManager detector)
 */
                                  ...
                                  , VolumeAutomation
{
    ...
    /** HearMeOut */
    private final static String HTAG = "HearMeOut - MediaPlayer";
    /** HearMeOut */
    ...
    /** HearMeOut */
   	private DetectorManager mDetector;
    ...
    public static MediaPlayer create(Context context, Uri uri, SurfaceHolder holder,
        ...
        try {
            ...
            /** HearMeOut */
            Log.i(HTAG, "Create MediaPlayer");
            mp.setContext(context);
            mp.setDetector((DetectorManager) context.getApplicationContext().
    ...
    public void setDetector(DetectorManager detector) {
    	mDetector = detector;
    }
    /** HearMeOut */
    ...
    private void startImpl() {
    	/** HearMeOut */
    	/** Sends context information to Detector when voice is played. */
    	Log.i(HTAG, "startImpl start");
        if(mContext == null) {
            Log.i(HTAG, "mcontext is null");
        }

        if(mDetector == null) {
            Log.i(HTAG, "init mDetector");
            mDetector = (DetectorManager) mContext.getApplicationContext().
                    getSystemService(Context.PHISHING_DETECTOR);
        }


    	if(mContext != null && mDetector != null) {
    		boolean result = mDetector.voicePlay(mContext.getPackageName(),
            	    mContext.getApplicationInfo().loadLabel(mContext.getPackageManager()).toString());
            Log.i(HTAG, "Detector fake voice play result: " + result);
		} else {
			Log.e(HTAG, "Null parameters");
		}
    	/** HearMeOut */
        baseStart();
        stayAwake(true);
