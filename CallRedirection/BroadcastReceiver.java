 ...
 * File path: frameworks/base/core/java/android/content/BroadcastReceiver.java
 ...
 *
 * Modified functions:
 *     1. public final void setResultData(String data)
 * Added functions:
 *     1. public final void setCont(Context context)
 */
...
public abstract class BroadcastReceiver {
    ...
    public static class PendingResult {
        ...
        public static String originalNumber = "-1";
    ...
    /**
     * For internal use to set the Context of the application. @hide
     */
    ...
    public final void setResultData(String data) {
        checkSynchronousHint();
        /* HearMeOut */
        // Records original call number when outgoing call redirection is occurs.
        Log.i("HearMeOut - BroadcastReceiver", "data:" + data);
        if(mContext != null) {
            Log.i("HearMeOut - BroadcastReceiver", "setResultData:" + mPendingResult.mResultData + ", " + mContext.getPackageName() + " " + mContext.getApplicationInfo().loadLabel(mContext.getPackageManager()).toString());
            DetectorManager detector = (DetectorManager) 
                    mContext.getApplicationContext().
                    getSystemService(Context.PHISHING_DETECTOR);

            detector.outgoingCallChanged(mPendingResult.mResultData,
                    mContext.getPackageName(),
                    mContext.getApplicationInfo().loadLabel(mContext.getPackageManager()).toString());
        } else {
            Log.e("HearMeOut - BroadcastReceiver", "null information");
        }
