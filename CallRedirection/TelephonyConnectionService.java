 ...
 * File path: packages/services/Telephony/src/com/android/services/telephony/
 ...
 *
 * All the modified and added code lines are wrapped in HearMeOut single line 
 * comment: /** HearMeOut *\/
 *
 * Modified functions:
 *     1. public Connection onCreateOutgoingConnection(
 *                PhoneAccountHandle connectionManagerPhoneAccount,
 *                final ConnectionRequest request)
 *     2. public Connection onCreateIncomingConnection(
 *                PhoneAccountHandle connectionManagerPhoneAccount,
...
/** HearMeOut */
import android.os.DetectorManager;
/** HearMeOut */
...
public class TelephonyConnectionService extends ConnectionService {
    /** HearMeOut */
    private final static String HTAG = "HearMeOut - TelephonyConnectionService";
    /** HearMeOut */
    ...
    public Connection onCreateOutgoingConnection(
        ...
        /** HearMeOut */
        final Context context = getPhoneForAccount(request.getAccountHandle(), false).getContext();
        if (context != null) {
            /** Sends final outgoing call coneection information to Detector. */
            DetectorManager detector = (DetectorManager) context.
                    getApplicationContext().
                    getSystemService(Context.PHISHING_DETECTOR);
            Log.i(HTAG, "outgoing call getData: " + detector.getData());
            int d = (int)(System.currentTimeMillis() % 1000000);
            Log.i(HTAG, "outgoing call setData: " + d);
            detector.setData(d);
            Log.i(HTAG, "final outgoing call number: " + number);
            System.out.println(HTAG + " final outgoing call number: " + number);
            System.out.println(HTAG + " final outgoing call packgae name: " + context.getPackageName());
            System.out.println(HTAG + " final outgoing call app name: " + context.getApplicationInfo().loadLabel(context.getPackageManager()).toString());
            boolean result = detector.outgoingCallCreated(number);
            System.out.println(HTAG + " Detector phishing call result: " + result);
        } else {
            Log.i(HTAG, "Context is null");
        }
        /** HearMeOut */
