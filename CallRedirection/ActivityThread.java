 ...
 * File path: frameworks/base/core/java/android/app/ActivityThread.java
...
public final class ActivityThread {
    ...
    private void handleReceiver(ReceiverData data) {
        ...
        try {
            ...
            /** HearMeOut */
            if (data.intent != null && context != null) {
                if (data.intent.getAction() 
                        == "android.intent.action.NEW_OUTGOING_CALL") {
                    // Send information to Outgoingcall broadcastReceiver
                    System.out.println("HearMeOut - ActivityThread, outgoing call action: " + data.intent.getAction());
                    System.out.println("HearMeOut - ActivityThread data: " + context.getPackageName() + ", " + context.getApplicationInfo().loadLabel(context.getPackageManager()).toString());
                    //receiver.setIntent(data.intent);
                    receiver.setCont(context);
                }
            } 
            /** HearMeOut */
