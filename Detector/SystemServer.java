 ...
 * File path: frameworks/base/services/java/com/android/server/SystemServer.java
 * Code style follows the below:
 *     1. https://source.android.com/setup/contribute/code-style
 *     2. https://google.github.io/styleguide/javaguide.html
 *
 * All the modified and added code lines are wrapped in / * HearMeOut * /
 *
 * Modified codes:
...
/* HearMeOut */
import com.android.server.Detector;
/* HearMeOut */
...
public final class SystemServer {
    ...
    private void startOtherServices() {
        ...
        try {
            ...
            /** HearMeOut */
            try {
                traceBeginAndSlog("StartDetector");
                detector = new Detector(context);
                ServiceManager.addService(Context.PHISHING_DETECTOR, detector);
                Slog.i("HearMeOut - SystemServer", "Detector starts");
                traceEnd();
            } catch (Exception ex) {
                Slog.e("HearMeOut - SystemServer", 
                        "Exception for adding Detector as a system service", 
                        ex);
            }
            /** HearMeOut */
